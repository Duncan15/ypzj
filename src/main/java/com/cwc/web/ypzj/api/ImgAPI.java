...
import com.cwc.web.common.api.resp.RespWrapper;
import com.cwc.web.common.util.PathParser;
import org.apache.commons.fileupload.FileItem;
import org.apache.commons.fileupload.disk.DiskFileItemFactory;
import org.apache.commons.fileupload.servlet.ServletFileUpload;

import com.cwc.web.ypzj.db.DAO.ImageRepository;
import com.cwc.web.ypzj.api.jsonObj.ImgUploadResponseUnit;
import com.cwc.web.ypzj.api.jsonObj.ImgUploadResponser;
					...
					if(fileName!=null&&!"".equals(fileName)) {
						...
						if(ansName==null) {
							...
							if(session.getAttribute("avatar_id")==null){
								//must delete this session attribute when store this id into db
